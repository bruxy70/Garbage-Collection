...
The monthly schedule has two flavors, it can trigger either on the nth occurence of a weekday in a month or on the set weekday in the nth week of the month.
