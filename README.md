...
| `exclude_country_holidays` | Yes | A country code (see [holidays](https://github.com/dr-prodigy/python-holidays) for the list of valid country codes).<br/>Automatically move collection on public holidays to the following day.<br/>*Example:* `US`   
